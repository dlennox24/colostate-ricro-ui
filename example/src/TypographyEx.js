...
import { SectionContainer } from 'colostate-ricro-ui'; // eslint-disable-line
...
const SideNavEx = props => {
  ...
  return (
    <SectionContainer type="display2" title="Typography">
      ...
      body text outside of any formatting tags (eg <code>&lt;p&gt;</code>, <code>&lt;a&gt;</code>,
      <code>&lt;i&gt;</code>, etc)
      <p>
        paragraph text with embeded <code>code text</code>
      </p>
      <p>
        another paragraph with <a href="#test">link text</a> in a sentence
      </p>
      <pre>{preString}</pre>
      <hr />
      ...
      <div style={{ padding: '10px' }}>
        ...
        <Button className={classes.button} variant="raised" color="secondary" disabled>
          Disabled
        </Button>
        <input
